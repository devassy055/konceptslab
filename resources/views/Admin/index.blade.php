...
-->
     ...
     <table>
       ...
       --> 
       <th><a class="btn btn-outline-warning rounded-pill" href="{{Route('user.create')}}">Add a new</a></th> </th>
    </thead>
    </table>
    <br>
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td></td>
                <td>
                    <a class="btn btn-outline-warning rounded-pill" href="{{Route('user.edit',$dest->id)}}">Edit</a></th>
                </td>
                <td>
